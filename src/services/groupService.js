...
export async function createCampingGroup(user, name, campingStyle) {
...
export async function joinCampingGroup(user, code) {
...
export function subscribeCampingGroup(groupId, callback, onError) {
  return onSnapshot(doc(db, "campingGroups", groupId), (snapshot) => {
    callback(snapshot.exists() ? { id: snapshot.id, ...snapshot.data() } : null);
  }, onError);
}

export function subscribeGroupMembers(groupId, callback, onError) {
